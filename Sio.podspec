#
#  Be sure to run `pod spec lint Sio.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "Sio"
  spec.version      = "1.0.0"
  spec.summary      = " A http client being easy to use URLSession."
...
with http connection,q
  ...
  spec.author             = { "kitaya" => "kworkshere@gmail.com" }
  # Or just: spec.author    = "kitaya"
  # spec.authors            = { "kitaya" => "kkitaya@nzigen.com" }
  spec.social_media_url   = "https://www.linkedin.com/in/kaito-kitaya-379a70274/"
